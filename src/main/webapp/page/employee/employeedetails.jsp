...
<html>
  ...
  <body>
    <div class="x-nav">
      ...
      <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${ctx }/employee/employeedetails?${employee.id}" title="刷新">
           ...
           <!--  <td class="td-status">
            ...
            <td class="td-manage">
             <!--  <a onclick="member_stop(this,'10001')" href="javascript:;"  title="启用">
              ...
              <a title="编辑"  href="${ctx}/employee/empadd?id=${employee.id }">
                <i class="layui-icon">&#xe642;</i>
              </a>
            </td>
          </tr>

...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm"  action="${ctx}/user/overtimeupdate">
            <input type="hidden" id="sort" name="sort" value="qingjia">
          <div class="layui-form-item" >
              <label for="begintime" class="layui-form-label">
                  <span class="x-red">*</span>加班日期
              </label>
          ...
          <div class="layui-form-item">
              <td class="td-manage">
              <a title="通过"  href="${ctx}/user/overtimeupdate?id=${dept.id }&state=approve" class="layui-btn layui-btn-primary layui-btn-xs">
                  通过
              </a>
              <a title="驳回" href="${ctx}/user/overtimeupdate?id=${dept.id }&state=reject" class="layui-btn layui-btn-primary layui-btn-xs">
                  驳回
              </a>
              </td>
          </div>
